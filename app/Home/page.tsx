...
export default function Homepage() {
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-start space-y-4 sm:ml-0 md:ml-24 lg:ml-72">
    {/* Button 1 */}
...
<section className="grid grid-cols-1 md:grid-cols-2 text-white">
  ...
  <Link href="">
    <div className="bg-darkblue flex flex-col justify-center items-start md:items-center px-6 md:px-16 lg:px-24 py-12">
      <Boxes className="w-8 h-8 lg:ml-20 text-white mb-2" />
      <h2 className="text-sm lg:ml-20 md:text-lg lg:text-xl font-bold text-left md:text-center">
  ...
  <Link href="">
    <div className="bg-white flex flex-col justify-center items-start md:items-center px-6 md:px-16 lg:px-24 py-12">
      <File className="w-8 h-8 text-blue lg:mr-20  mb-2" />
      <h2 className="text-sm md:text-lg lg:text-xl lg:mr-20 font-bold text-blue text-left md:text-center">
